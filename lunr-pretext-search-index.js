...
},
{
  "id": "Proj5-4",
  "level": "2",
  "url": "Projects.html#Proj5-4",
  "type": "Checkpoint",
  "number": "3.30",
  "title": "",
  "body": "Procure uma imagem quadrada (e. g. 1080 x 1080, 400 x 400) qualquer para ver sua representação em três canais. Você deve fornecer ao programa o link de uma imagem. Observação: Devido a uma trava existente no SageMath (recurso utilizado para executar os códigos no site), o programa não consegue se comunicar com a maioria dos sites. Sabe-se que quaisquer links de imagens da wikipedia (wikimedia) conseguem ser acessados para obter a imagem. Portanto, utilize alguma imagem proveniente de  https:\/\/commons.wikimedia.org\/wiki\/Category:Square_images . Se você decidir executar o código diretamente em sua máquina, qualquer link, independente do site de origem, funcionará. "
},
{
  "id": "Proj5-5",
  "level": "2",
  "url": "Projects.html#Proj5-5",
  "type": "Remark",
  "number": "3.31",
  "title": "",
  "body": " Agora, iremos analisar os autovalores e autovetores associados à matriz da imagem em preto e branco para realizar uma decomposição .  "
},
{
  "id": "Proj5-6",
  "level": "2",
  "url": "Projects.html#Proj5-6",
  "type": "Checkpoint",
  "number": "3.32",
  "title": "",
  "body": "O programa a seguir extrai os autovalores da imagem em preto e branco e os coloca em ordem decrescente de magnitude (norma ou tamanho). Você pode observar graficamente o módulo de cada autovalor, bem como o peso acumulado (soma dos módulos dos primeiros autovalores de 0 a dividida pela soma de todos os autovalores). Com base nisso indique, justificando a sua resposta: quantos dos primeiros autovalores você precisaria manter para obter 20% da qualidade da imagem? E 50%? E 90%? Justifique suas respostas. Observe que uma boa parte dos autovalores é insignificante se comparada à soma dos módulos de todos os autovalores. Esse conjunto de valores pequenos pode ser descartado sem grandes perdas de qualidade na imagem, mas com significativo impacto em seu tamanho no armazenamento. "
},
{
  "id": "Proj5-10",
  "level": "2",
  "url": "Projects.html#Proj5-10",
  "type": "Checkpoint",
  "number": "3.33",
  "title": "",
  "body": "Agora, execute o código abaixo para visualizar a imagem compactada gerada ao utilizar a decomposição mantendo apenas os primeiros autovalores, para os valores escolhidos no checkpoint anterior. Os resultados corresponde ao que você esparava? "
},
{
  "id": "Proj5-11",
  "level": "2",
  "url": "Projects.html#Proj5-11",
  "type": "Checkpoint",
  "number": "3.34",
  "title": "",
  "body": "Quantas números a matriz da foto original em escala cinza continha? Quantos números têm as matrizes obtidas mantendo apenas autovalores para cada um dos três casos que escolheu utilizar? Qual a economia de espaço obtida em cada um dos casos? "
},
{
  "id": "Proj6-3",
  "level": "2",
  "url": "Projects.html#Proj6-3",
  "type": "Remark",
  "number": "3.35",
  "title": "",
  "body": " Para decompor uma matriz , , utilizando SVD, precisamos primeiro calcular duas matrizes: , de ordem e , de ordem   Observe que estas duas matrizes são simétricas, e portanto possuem e autovalores reais e distintos, respectivamente. Se ordenarmos estes autovalores, os correspondentes de cada matriz serão iguais, isto é, o autovalor mais significativo de é igual ao autovalor mais significativo de , assim como o segundo autovalor mais significativo de cada matriz, e assim em diante.  Definem-se, então, as matrizes e :    é a matriz cujas colunas são os autovetores de    é a matriz cujas colunas são os autovetores de    Por fim, define-se uma matriz :   Onde cada é um valor singular de , de modo que .  Em linhas gerais, é uma matriz cujas primeiras linhas correspondem a uma matriz diagonal com os valores singulares em sua diagonal principal. Suas linhas restantes contém somente zeros.  Assim sendo, temos a decomposição em valores singulares de como:   "
},
{
  "id": "Proj6-4",
  "level": "2",
  "url": "Projects.html#Proj6-4",
  "type": "Checkpoint",
  "number": "3.36",
  "title": "",
  "body": "Escolha uma imagem retangular para fazer sua decomposição SVD (lembre-se de utilizar uma imagem da Wikimedia). O programa a seguir extrai os valores singulares da imagem em preto e branco e os coloca em ordem decrescente de magnitude (norma ou tamanho). Você pode observar graficamente o módulo de cada valor singular, bem como o peso acumulado (soma dos módulos dos primeiros valores de 0 a dividida pela soma de todos os valores). Com base nisso indique, justificando a sua resposta: quantos dos primeiros valores singulares você precisaria manter para obter 20% da qualidade da imagem? E 50%? E 90%? Justifique suas respostas. "
},
{
  "id": "Proj6-6",
  "level": "2",
  "url": "Projects.html#Proj6-6",
  "type": "Checkpoint",
  "number": "3.37",
  "title": "",
  "body": "Agora insira a quantidade de valores singulares que deseja manter para observar a imagem compactada: "
},
{
...
},
{
  "id": "aplicacoes-16",
  "level": "2",
  "url": "auto_val.html#aplicacoes-16",
  "type": "Checkpoint",
  "number": "9.20",
  "title": "",
  "body": "Resolva o sistema  "
...
},
{
  "id": "aplicacoes_2-12",
  "level": "2",
  "url": "auto_val.html#aplicacoes_2-12",
  "type": "Example",
  "number": "9.24",
  "title": "",
  "body": "  Resolva o sistema    "
