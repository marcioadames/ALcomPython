...
},
{
  ...
  "number": "3.31",
  "title": "",
  "body": " Agora, iremos analisar os autovalores e autovetores associados à matriz da imagem em preto e branco para realizar uma decomposição .  Nesta decomposição, multilplica-se a matriz , cujas colunas são os autovetores de , pela matriz diagonal , que contem os autovalores da matriz em sua diagonal principal. O produto é, então, multiplicado por . Pode-se interpretar o produto como a operação de \"esticar\" cada autovetor através da multiplicação por seu autovalor correspondente. Nesse contexto, autovalores muito próximos de 0 tem um efeito quase insignificante na matriz final , e por isso, podemos descartá-los, bem como os autovetores associados a eles.  Ao mantermos apenas os autovalores mais significativos da matriz , a matriz passa a ter ordem . Os autovetores referentes aos autovalores eliminados também são descartados, de modo a excluir as referentes colunas de , que passa a ter ordem , bem como as referentes linhas de , que passa a ter ordem .  Este processo pode ser usado para comprimir imagens, eliminando uma quantidade significativa da memória utilizada para armazená-la.  "
},
{
  "id": "Proj5-6",
  "level": "2",
  ...
  "number": "3.32",
  "title": "",
  "body": "O programa a seguir extrai os autovetores da imagem em preto e branco e os ordena. Você pode observar graficamente o módulo de cada autovalor, bem como o peso acumulado (soma de todos os autovalores de 0 a ). Com base nisso, reflita: Quantos autovalores você manteria? Quantos você descartaria? Observe que uma boa parte dos autovalores é insignificante se comparada à soma dos módulos de todos os autovalores. Esse conjunto de valores pequenos pode ser descartado sem grandes perdas de qualidade na imagem, mas com significativo impacto em seu tamanho no armazenamento. "
},
{
  "id": "Proj5-7",
  "level": "2",
  "url": "Projects.html#Proj5-7",
  "type": "Checkpoint",
  "number": "3.33",
  "title": "",
  "body": "Agora, execute o código abaixo para visualizar a imagem compactada gerada ao utilizar a decomposição e manter apenas os primeiros autovalores: "
},
{
  "id": "Proj6-3",
  "level": "2",
