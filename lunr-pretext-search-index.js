...
},
{
  ...
  "body": " Sistemas de Equações Lineares   Nessa seção introduzimos sistemas lineares e áplicações práticas.    Projeto 1 - Criando uma dieta  Desenvolva os itens abaixo para determinar as quantidedes ideais de cada alimento para atingir seus objetivos nutricionais com alimentos da sua escolha.  Encontre as quantides de fibra alimentar, carboidratos, sódio, proteínas e gorduras no site https:\/\/tabnut.dis.epm.br\/alimento de 5 alimentos de sua escolha. Exemplo de solução (seus alimentos serão, provavelmente, diferentes).  Escreva um sistema linear que represente o problema que você está tentando resolver. Algum texto.  Utilize o código na para resolver o sistema linear. Algum texto.   Código para a resolução de sistemas lineares utilizando o método de Gauss-Jordan.     A solução encontrada faz sentido? Há algo inconveniente ou inadequado na solução? Justifique sua resposta. Algum texto.  Remova um dos alimentos de sua lista e tente determinar as quantidedes ideais de cada alimento para atingir seus objetivos nutricionais. Qual o resulta obtido? O que você acha que ocorreu? Algum texto.  Faça uma lista com um total de 7 alimentos e tente determinar as quantidedes ideais de cada alimento para atingir seus objetivos nutricionais. Qual o resulta obtido? O que você faria para obter uma resposta? Uma possibilidade é fixar os valores das variáveis livres a seu critério. Outra opção (mais utilizada em problemas práticos) é minimizar determinadas variáveis, como a seguir:   Código para a resolução de sistemas lineares utilizando o método de Gauss-Jordan.    "
},
{
  "id": "Proj1-3",
  "level": "2",
  "url": "sistemas-lineares.html#Proj1-3",
  "type": "Checkpoint",
  "number": "1.1",
  "title": "",
  "body": "Encontre as quantides de fibra alimentar, carboidratos, sódio, proteínas e gorduras no site https:\/\/tabnut.dis.epm.br\/alimento de 5 alimentos de sua escolha. Exemplo de solução (seus alimentos serão, provavelmente, diferentes). "
},
{
  "id": "Proj1-4",
  "level": "2",
  "url": "sistemas-lineares.html#Proj1-4",
  "type": "Checkpoint",
  "number": "1.2",
  "title": "",
  "body": "Escreva um sistema linear que represente o problema que você está tentando resolver. Algum texto. "
},
{
  "id": "Proj1-5",
  "level": "2",
  "url": "sistemas-lineares.html#Proj1-5",
  "type": "Checkpoint",
  "number": "1.3",
  "title": "",
  "body": "Utilize o código na para resolver o sistema linear. Algum texto. "
},
{
  "id": "sol_lin_sys",
  "level": "2",
  "url": "sistemas-lineares.html#sol_lin_sys",
  "type": "Remark",
  "number": "1.4",
  "title": "",
...
{
  "id": "sistemas-lineares-4",
  "level": "2",
  "url": "sistemas-lineares.html#sistemas-lineares-4",
  "type": "Checkpoint",
  "number": "1.5",
  "title": "",
  "body": "A solução encontrada faz sentido? Há algo inconveniente ou inadequado na solução? Justifique sua resposta. Algum texto. "
},
{
  "id": "sistemas-lineares-5",
  "level": "2",
  "url": "sistemas-lineares.html#sistemas-lineares-5",
  "type": "Checkpoint",
  "number": "1.6",
  "title": "",
...
{
  "id": "sistemas-lineares-6",
  "level": "2",
  "url": "sistemas-lineares.html#sistemas-lineares-6",
  "type": "Checkpoint",
  "number": "1.7",
  "title": "",
  "body": "Faça uma lista com um total de 7 alimentos e tente determinar as quantidedes ideais de cada alimento para atingir seus objetivos nutricionais. Qual o resulta obtido? O que você faria para obter uma resposta? Uma possibilidade é fixar os valores das variáveis livres a seu critério. Outra opção (mais utilizada em problemas práticos) é minimizar determinadas variáveis, como a seguir: "
},
{
  "id": "minmax_lin_sys",
  "level": "2",
  "url": "sistemas-lineares.html#minmax_lin_sys",
  "type": "Remark",
  "number": "1.8",
  "title": "",
  "body": " Código para a resolução de sistemas lineares utilizando o método de Gauss-Jordan.   "
